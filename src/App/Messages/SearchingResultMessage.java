...
public class SearchingResultMessage extends Message {
    private String chatId;
    private String serializedData;
    private ArrayList<String> serializedDataList;

    public SearchingResultMessage(String chatId, String serializedData) {
        super(MessageType.SEARCH_RESULT);
        this.chatId = chatId;
    ...
    public static SearchingResultMessage fromString(String message) throws InvalidMessageException {
        SearchingResultMessage peerDataMessage = new SearchingResultMessage("", "");
    ...
    public static String getNACK() {
        return MessageType.SEARCH_RESULT + "@NACK";
    }
}
